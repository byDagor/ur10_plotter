...
def create_layout(safe_z_offset, pen_change_z_offset):
    ...
    flow_controls = [
        ...
        [sg.Checkbox("Use CMYK Layers", key="-FLOW_CMYK-", default=False), sg.Checkbox("K-d Tree (`-kdt`)", key="-FLOW_KDT-", default=True), sg.Checkbox("Trim Border (`-tm`)", key="-FLOW_TRIM-", default=False)],
    ...
    hatched_controls = [
        ...
        [sg.Checkbox("Draw Contours", key="-HATCHED_LINES-", default=False), sg.Checkbox("Draw Hatch Fill", key="-HATCHED_HATCH-", default=True)],
    ...
    text_editor_controls = [
        ...
        [sg.Text("Line Spacing:", size=(15,1)), sg.Input("0.4", size=(10,1), key="-TEXT_LINE_SPACING-", enable_events=True)],
